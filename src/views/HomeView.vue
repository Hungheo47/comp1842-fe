...
<template>
      ...
      <template #bodyCell="{ column, record }">
        <template v-if="column.key === 'action'">
          <span class="flex gap-2">
            ...
            <a-button type="link" danger @click="handleDeleteUser(record._id)">Delete</a-button>
          </span>
        </template>
        <!-- Keep default rendering for other columns -->
        <template v-else>
  ...
  <a-modal v-model:visible="open" title="Edit User" @ok="handleOk(form._id)" @cancel="handleCancel">
